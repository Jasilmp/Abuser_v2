...
module.exports = {
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '917025894178@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ✰ɪᴀͥᴍ ͣᴀͫʙᴜ ʙᴏᴛ✰ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '917925994178,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
